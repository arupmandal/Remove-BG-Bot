...
- **Developer :** [Arup Mandal](https://github.com/arupmandal)
- **Channel :** [Arup Bots](https://telegram.me/arupbots)
- **Source :** [Click here](https://github.com/cyberboyarup/Remove-BG-Bot)
...
START_BUTTONS = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton('Join Channel', url='https://telegram.me/arupbots')
        ],
        [
